...
# Constants
USER_DATA_FILE = '/Users/xavierroshan/Desktop/Learning/Python/studysession/StockAnalysis/user_data.csv'
...
if user_input == 'y':
    ...
    while True:
        ...
        user_data.append({'symbol': symbol, 'num_shares': num_shares, 'cost_price': cost_price})
        
        done = input("Are you done with the entries? (y/n) ").lower()
        if done == 'y':
            break
...
df.to_csv('/Users/xavierroshan/Desktop/Learning/Python/studysession/StockAnalysis/stock_portfolio.csv', index=True)
